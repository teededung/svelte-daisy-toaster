...
export class ToastState {
  ...
  update(
    id: string,
    partial?: Partial<Omit<Toast, "id" | "_toastState">> & {
      durationMs?: number;
    }
  ): void;
...
export type ToastUpdate = Partial<Omit<Toast, "id" | "_toastState">> & {
  durationMs?: number;
};

export type ToastLoadingController = {
  /** Id of the underlying toast. */
  id: string;
  /** Turn the loading toast into a success toast. */
  ...
  /** Turn the loading toast into an info toast. */
  info: (msg?: string, extra?: ToastUpdate) => void;
  /** Turn the loading toast into a warning toast. */
...
export interface ToastFunction {
   ...
   * options object.
   */
  (message: string | ToastOptions): Toast | undefined;
   ...
   */
  loading(message?: string, options?: ToastOptions): ToastLoadingController | undefined;
}
